...
document.addEventListener("DOMContentLoaded", () => {
    const matrixSize = 14; // Size of the matrix
    ...
    // Method to apply blue color to specific cells
    ...
    // Method to remove blue color from specific cells
    ...
    document.getElementById("slider6").addEventListener("input", (event) => {
        event.target.checked ? colorCells(Evi, "6_1") : removeColor(Evi, "6_1");
        event.target.checked ? colorCells(Evi_exclude, "6_2") : removeColor(Evi_exclude, "6_2");
    });
    document.getElementById("slider7").addEventListener("input", (event) => {
